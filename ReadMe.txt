================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet server_socket_test
===============================================================================

L'Assistant Application a créé cette application server_socket_test pour  
...
constituent votre application server_socket_test.

server_socket_test.vcproj
...
res\server_socket_test.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application.  
Cette 
    icône est incluse par le fichier de ressource principal server_socket_test.rc.

res\server_socket_test.rc2
...
serverSocketTestDlg.h, serverSocketTestDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CserverSocketTestDlg.  Cette classe 
définit 
    le comportement de la boîte de dialogue principale de votre application.  Le 
modèle de boîte de dialogue se trouve 
    dans server_socket_test.rc et peut être modifié dans Microsoft Visual 
C++.
...
(PCH) 
    nommé server_socket_test.pch et un fichier de type précompilé nommé 
Stdafx.obj.
